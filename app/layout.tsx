            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <Link href={"/controlPanel"} className="flex items-center p-2 rounded-lg group">
                  ...
                  <span className="ms-3">İdarə paneli</span>
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="/#" className="flex items-center p-2 rounded-lg group">
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Sifarişlər</span>
                </a>
              </li>
              <li>
                <Link href={"/grade"} className="flex items-center p-2 text-gray-900 rounded-lg group">
                  <StarBorderIcon className="text-gray-400" />
                  <span className="flex-1 ms-3 whitespace-nowrap">Qiymətləndirmə</span>
                </Link>
              </li>
              <li>
            ...
            <nav className="bg-white border-gray-200">
              <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:flex md:items-center md:w-auto" id="navbar-default">
                  ...
                  <Image width={40} height={40} className="w-10 h-10 rounded-full"  alt="Rounded avatar"/>
                </div>
              </div>
            </nav>
